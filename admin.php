...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  mysqli_stmt_bind_param($stmt, "sssssssss", $nama, $alamat, $telepon, $email, $linkedin, $pendidikan, $pengalaman_kerja, $keterampilan, $foto_path);
  ...
  <!-- <div class="container mt-5"> -->
    <nav class="navbar sticky-top navbar-custom">
      <div class="container-fluid">
        <h1 class="font-custom">UPDATE CV</h1>
        <a class="btn btn-custom-bg btn-custom-text" href="/cv">VIEW</a>
      </div>
    </nav>
    <div class="card">
      <div class="p-3">
        <div class="card-body">
          <form method="post">
            ...
            <button type="submit" class="btn btn-custom-bg btn-custom-text">SAVE</button>
          </form>
        </div>
      </div>
    </div>
